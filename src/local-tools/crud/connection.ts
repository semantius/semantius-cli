...
/**
 * Run vendored code with (1) console.log forwarded to debug() — upstream logs
 * every request to stdout, a server log on Deno but output corruption here —
 * and (2) the GUARDED_ENV_VARS hidden. Both are restored afterwards.
 */
