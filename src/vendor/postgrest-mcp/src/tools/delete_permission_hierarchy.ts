/**
 * Delete Permission Hierarchy Tool
 * Permanently deletes a permission hierarchy record by ID
 */
...
const inputSchema = {
  id: oneOrMany(z.string()).describe(
    `ID of the permission hierarchy to delete, or a non-empty array of IDs to delete several records in one request. ` +
...
export const deletePermissionHierarchyTool: Tool<typeof inputSchema, undefined> = {
  name: 'delete_permission_hierarchy',
  options: {
    title: 'Delete Permission Hierarchy',
    description: `Permanently deletes a permission hierarchy record by ID. ` +
