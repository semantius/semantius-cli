/**
 * Read Role Permission Tool
 * Reads and queries role permissions from the role_permissions table
 */
...
export const readRolePermissionTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_role_permission',
  options: {
    title: 'Read Role Permission',
    description: `Reads and queries role permissions from the role_permissions table. ` +
