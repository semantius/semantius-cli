/**
 * Read Role Tool
 * Reads and queries roles from the roles table
 */
...
export const readRoleTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_role',
  options: {
    title: 'Read Role',
    description: `Reads and queries roles from the roles table. ` +
