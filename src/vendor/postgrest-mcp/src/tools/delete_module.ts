/**
 * Delete Module Tool
 * Permanently deletes a module record by ID
 */
...
const inputSchema = {
  id: oneOrMany(z.number().int()).describe(
    `ID of the module to delete, or a non-empty array of IDs to delete several records in one request. ` +
...
export const deleteModuleTool: Tool<typeof inputSchema, undefined> = {
  name: 'delete_module',
  options: {
    title: 'Delete Module',
    description: `Permanently deletes a module record by ID. ` +
