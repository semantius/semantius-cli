/**
 * Read Permission Hierarchy Tool
 * Reads and queries permission hierarchy from the permission_hierarchy table
 */
...
export const readPermissionHierarchyTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_permission_hierarchy',
  options: {
    title: 'Read Permission Hierarchy',
    description: `Reads and queries permission hierarchy from the permission_hierarchy table. ` +
