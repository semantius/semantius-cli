/**
 * Read Field Tool
 * Reads and queries fields from the fields table
 */
...
export const readFieldTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_field',
  options: {
    title: 'Read Field',
    description: `Reads and queries fields from the fields table. ` +
