...
export const userSchema = z.looseObject({
  ...
  external_id: z.string().optional().describe('Identity: the JWT sub claim from the authentication provider. Never empty: a human user must bring one, and an agent saved without one gets agent:<uuid>.'),
