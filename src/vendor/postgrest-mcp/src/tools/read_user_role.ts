/**
 * Read User Role Tool
 * Reads and queries user roles from the user_roles table
 */
...
export const readUserRoleTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_user_role',
  options: {
    title: 'Read User Role',
    description: `Reads and queries user roles from the user_roles table. ` +
