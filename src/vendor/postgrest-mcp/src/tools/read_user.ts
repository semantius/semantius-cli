/**
 * Read User Tool
 * Reads and queries users from the users table
 */
...
export const readUserTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_user',
  options: {
    title: 'Read User',
    description: `Reads and queries users from the users table. ` +
