/**
 * Read Webhook Receiver Tool
 * Reads and queries webhook receivers from the webhook_receivers table
 */
...
export const readWebhookReceiverTool: Tool<typeof inputSchema, undefined> = {
  name: 'read_webhook_receiver',
  options: {
    title: 'Read Webhook Receiver',
    description: `Reads and queries webhook receivers from the webhook_receivers table. ` +
